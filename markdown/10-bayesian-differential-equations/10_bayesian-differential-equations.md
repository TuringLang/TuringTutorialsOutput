...
Wall duration     = 52.7 seconds
Compute duration  = 52.21 seconds
...
Summary Statistics
  ...
  e ⋯
    ...
    ⋯
           ...
           σ    1.6514    0.5678    0.2293     9.4530    73.9243    1.6735 
    ⋯
           α    1.0451    0.4101    0.1628     7.4026    74.0864    2.3414 
    ⋯
           β    0.9040    0.1739    0.0361    26.5754    98.7184    1.1545 
    ⋯
           γ    2.2291    0.7893    0.3000     8.0049    75.8544    2.0116 
    ⋯
           δ    0.8582    0.2014    0.0661    10.5117    69.5339    1.5248 
    ⋯
                                                                1 column om
itted
...
Quantiles
  parameters      2.5%     25.0%     50.0%     75.0%     97.5%
      Symbol   Float64   Float64   Float64   Float64   Float64
           ...
           σ    0.7986    0.8876    1.9733    2.0792    2.2433
           α    0.5017    0.5252    1.1782    1.4314    1.5581
           β    0.5562    0.7720    0.9451    1.0259    1.1932
           γ    1.0161    1.4650    2.2933    2.9748    3.3280
           δ    0.4951    0.6982    0.8862    1.0288    1.1561
```
...
Wall duration     = 42.71 seconds
Compute duration  = 41.97 seconds
parameters        = σ, α, β, γ, δ
internals         = lp, n_steps, is_accept, acceptance_rate, log_density, h
amiltonian_energy, hamiltonian_energy_error, max_hamiltonian_energy_error, 
tree_depth, numerical_error, step_size, nom_step_size
...
Quantiles
  parameters      2.5%     25.0%     50.0%     75.0%     97.5%
      Symbol   Float64   Float64   Float64   Float64   Float64
           ...
           δ    0.5137    0.7841    0.9607    1.2019    1.5055
```
...
Compute duration  = 28.68 seconds
parameters        = σ, α, β, γ, δ
internals         = lp, n_steps, is_accept, acceptance_rate, log_density, h
amiltonian_energy, hamiltonian_energy_error, max_hamiltonian_energy_error, 
tree_depth, numerical_error, step_size, nom_step_size
...
Summary Statistics
  ...
  e ⋯
    ...
    ⋯
           ...
           σ    0.4588    0.0240    0.0011   497.6914   392.4457    1.0049 
    ⋯
           α    1.4809    0.0579    0.0038   229.4872   307.0914    1.0118 
    ⋯
           β    1.0082    0.0442    0.0027   270.4566   381.7370    1.0135 
    ⋯
           γ    3.0956    0.1469    0.0102   210.4060   266.2178    1.0128 
    ⋯
           δ    1.0315    0.0509    0.0035   212.9829   294.2844    1.0133 
    ⋯
                                                                1 column om
itted
...
Quantiles
  parameters      2.5%     25.0%     50.0%     75.0%     97.5%
      Symbol   Float64   Float64   Float64   Float64   Float64
           ...
           σ    0.4137    0.4434    0.4587    0.4724    0.5097
           α    1.3787    1.4409    1.4758    1.5167    1.6051
           β    0.9268    0.9779    1.0043    1.0360    1.1056
           γ    2.7955    3.0012    3.0960    3.1957    3.3703
           δ    0.9282    0.9977    1.0323    1.0662    1.1283
```
...
Number of chains  = 1
Samples per chain = 1000
Wall duration     = 1055.58 seconds
Compute duration  = 1055.58 seconds
parameters        = σ, α, β, γ, δ
internals         = lp, n_steps, is_accept, acceptance_rate, log_density, h
amiltonian_energy, hamiltonian_energy_error, max_hamiltonian_energy_error, 
tree_depth, numerical_error, step_size, nom_step_size
...
Summary Statistics
  ...
  e ⋯
    ...
    ⋯
           ...
           σ    0.8585    0.0431    0.0026   286.5701   345.0618    1.0009 
    ⋯
           α    1.4851    0.0532    0.0029   333.6569   455.1486    1.0075 
    ⋯
           β    1.0249    0.0501    0.0027   333.5099   513.0850    1.0083 
    ⋯
           γ    3.0233    0.1572    0.0083   354.4450   526.0406    1.0071 
    ⋯
           δ    1.0318    0.0579    0.0032   331.2198   432.0040    1.0082 
    ⋯
                                                                1 column om
itted
...
Quantiles
  parameters      2.5%     25.0%     50.0%     75.0%     97.5%
      Symbol   Float64   Float64   Float64   Float64   Float64
           ...
           σ    0.7727    0.8315    0.8576    0.8865    0.9436
           α    1.3848    1.4499    1.4832    1.5204    1.5906
           β    0.9366    0.9919    1.0220    1.0564    1.1285
           γ    2.7213    2.9210    3.0222    3.1195    3.3379
           δ    0.9234    0.9926    1.0314    1.0679    1.1489
```
...
Number of chains  = 1
Samples per chain = 1000
Wall duration     = 1060.63 seconds
Compute duration  = 1060.63 seconds
parameters        = σ, α, β, γ, δ
internals         = lp, n_steps, is_accept, acceptance_rate, log_density, h
amiltonian_energy, hamiltonian_energy_error, max_hamiltonian_energy_error, 
tree_depth, numerical_error, step_size, nom_step_size
...
Summary Statistics
  ...
  e ⋯
    ...
    ⋯
           ...
           σ    0.8563    0.0435    0.0021   420.0172   601.8148    1.0025 
    ⋯
           α    1.4742    0.0551    0.0041   171.4364   117.5938    1.0122 
    ⋯
           β    1.0166    0.0526    0.0031   282.2381   449.8249    0.9992 
    ⋯
           γ    3.0583    0.1625    0.0121   182.4543   223.2766    1.0067 
    ⋯
           δ    1.0442    0.0612    0.0047   172.6119   130.2600    1.0136 
    ⋯
                                                                1 column om
itted
...
Quantiles
  parameters      2.5%     25.0%     50.0%     75.0%     97.5%
      Symbol   Float64   Float64   Float64   Float64   Float64
           ...
           σ    0.7744    0.8275    0.8554    0.8824    0.9455
           α    1.3760    1.4330    1.4740    1.5100    1.5918
           β    0.9224    0.9801    1.0126    1.0495    1.1249
           γ    2.7355    2.9498    3.0463    3.1726    3.3722
           δ    0.9312    1.0004    1.0422    1.0869    1.1667
```
...
Status `/cache/build/default-amdci4-7/julialang/turingtutorials/tutorials/10-bayesian-differential-equations/Project.toml`
  ...
  [1ed8b502] SciMLSensitivity v7.41.1
