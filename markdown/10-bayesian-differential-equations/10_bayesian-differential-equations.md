...
Wall duration     = 64.8 seconds
Compute duration  = 64.48 seconds
...
Summary Statistics
  ...
  e ⋯
    ...
    ⋯
           ...
           σ    1.2572    0.5678    0.2303     9.5255    84.9827    1.6635 
    ⋯
           α    1.1588    0.4546    0.1847     9.5528    71.5902    1.6669 
    ⋯
           β    0.9503    0.1549    0.0418    18.9388    76.5783    1.3457 
    ⋯
           γ    2.8032    0.4371    0.1439    11.3363    86.7025    1.4849 
    ⋯
           δ    0.9805    0.1237    0.0354    14.3858   119.0346    1.3328 
    ⋯
                                                                1 column om
itted
...
Quantiles
  parameters      2.5%     25.0%     50.0%     75.0%     97.5%
      Symbol   Float64   Float64   Float64   Float64   Float64
           ...
           σ    0.7865    0.8429    0.8891    1.9797    2.1986
           α    0.5018    0.5263    1.4391    1.4953    1.5799
           β    0.5786    0.9099    0.9936    1.0435    1.1527
           γ    1.7406    2.5517    2.9395    3.1024    3.3704
           δ    0.6913    0.9247    1.0066    1.0630    1.1638
```
...
Wall duration     = 48.64 seconds
Compute duration  = 48.2 seconds
parameters        = σ, α, β, γ, δ
internals         = lp, n_steps, is_accept, acceptance_rate, log_density, h
amiltonian_energy, hamiltonian_energy_error, max_hamiltonian_energy_error, 
tree_depth, numerical_error, step_size, nom_step_size
...
Summary Statistics
  ...
  e ⋯
    ...
    ⋯
           ...
           σ    0.8693    0.0605    0.0058    98.5293   105.2360    1.0317 
    ⋯
           α    1.5380    0.1955    0.0216    83.7685   181.2451    1.0598 
    ⋯
           β    1.0767    0.1530    0.0163    90.4312   241.6328    1.0523 
    ⋯
           γ    3.0335    0.3135    0.0343    85.3939   220.5756    1.0590 
    ⋯
           δ    0.9846    0.2586    0.0283    85.5894   181.8517    1.0585 
    ⋯
                                                                1 column om
itted
...
Quantiles
  parameters      2.5%     25.0%     50.0%     75.0%     97.5%
      Symbol   Float64   Float64   Float64   Float64   Float64
           ...
           σ    0.7691    0.8282    0.8619    0.9067    1.0071
           α    1.2477    1.3931    1.5075    1.6463    1.9963
           β    0.8434    0.9641    1.0518    1.1626    1.4369
           γ    2.4253    2.8183    3.0321    3.2680    3.6097
           δ    0.4912    0.8017    0.9879    1.1663    1.4740
```
...
Compute duration  = 23.14 seconds
parameters        = σ, α, β, γ, δ
internals         = lp, n_steps, is_accept, acceptance_rate, log_density, h
amiltonian_energy, hamiltonian_energy_error, max_hamiltonian_energy_error, 
tree_depth, numerical_error, step_size, nom_step_size
...
Summary Statistics
  ...
  e ⋯
    ...
    ⋯
           ...
           σ    0.5153    0.0249    0.0010   671.5674   509.8985    1.0050 
    ⋯
           α    1.4671    0.0589    0.0040   219.2397   230.7632    1.0247 
    ⋯
           β    1.0099    0.0515    0.0028   331.9071   418.2304    1.0103 
    ⋯
           γ    3.1485    0.1425    0.0101   200.5817   280.4849    1.0236 
    ⋯
           δ    1.0432    0.0497    0.0035   199.3711   245.1677    1.0317 
    ⋯
                                                                1 column om
itted
...
Quantiles
  parameters      2.5%     25.0%     50.0%     75.0%     97.5%
      Symbol   Float64   Float64   Float64   Float64   Float64
           ...
           σ    0.4718    0.4964    0.5134    0.5323    0.5650
           α    1.3623    1.4256    1.4640    1.5051    1.5923
           β    0.9149    0.9736    1.0078    1.0461    1.1112
           γ    2.8700    3.0507    3.1510    3.2373    3.4348
           δ    0.9475    1.0109    1.0430    1.0764    1.1410
```
...
Number of chains  = 1
Samples per chain = 1000
Wall duration     = 1041.92 seconds
Compute duration  = 1041.92 seconds
parameters        = σ, α, β, γ, δ
internals         = lp, n_steps, is_accept, acceptance_rate, log_density, h
amiltonian_energy, hamiltonian_energy_error, max_hamiltonian_energy_error, 
tree_depth, numerical_error, step_size, nom_step_size
...
Summary Statistics
  ...
  e ⋯
    ...
    ⋯
           ...
           σ    0.8529    0.0429    0.0021   421.5077   400.4900    1.0011 
    ⋯
           α    1.4794    0.0537    0.0034   263.2063   229.7776    1.0000 
    ⋯
           β    1.0225    0.0519    0.0032   273.2667   233.5941    1.0013 
    ⋯
           γ    3.0426    0.1593    0.0095   280.5615   265.3469    1.0001 
    ⋯
           δ    1.0386    0.0587    0.0037   252.3454   265.1791    1.0001 
    ⋯
                                                                1 column om
itted
...
Quantiles
  parameters      2.5%     25.0%     50.0%     75.0%     97.5%
      Symbol   Float64   Float64   Float64   Float64   Float64
           ...
           σ    0.7752    0.8247    0.8528    0.8797    0.9376
           α    1.3766    1.4462    1.4767    1.5107    1.5947
           β    0.9343    0.9852    1.0211    1.0546    1.1334
           γ    2.7197    2.9382    3.0362    3.1419    3.3727
           δ    0.9249    1.0020    1.0363    1.0746    1.1617
```
...
Number of chains  = 1
Samples per chain = 1000
Wall duration     = 537.89 seconds
Compute duration  = 537.89 seconds
parameters        = σ, α, β, γ, δ
internals         = lp, n_steps, is_accept, acceptance_rate, log_density, h
amiltonian_energy, hamiltonian_energy_error, max_hamiltonian_energy_error, 
tree_depth, numerical_error, step_size, nom_step_size
...
Summary Statistics
  ...
  e ⋯
    ...
    ⋯
           ...
           σ    2.0540    0.1038    0.0037   797.2668   635.6097    0.9991 
    ⋯
           α    0.5187    0.0190    0.0010   405.8057   418.1406    1.0044 
    ⋯
           β    0.8251    0.2130    0.0135   316.4828   228.7751    0.9993 
    ⋯
           γ    2.3590    0.4042    0.0258   249.1638   264.3801    1.0021 
    ⋯
           δ    0.8732    0.1295    0.0088   229.9006   217.4193    1.0029 
    ⋯
                                                                1 column om
itted
...
Quantiles
  parameters      2.5%     25.0%     50.0%     75.0%     97.5%
      Symbol   Float64   Float64   Float64   Float64   Float64
           ...
           σ    1.8704    1.9806    2.0501    2.1238    2.2666
           α    0.5008    0.5059    0.5127    0.5239    0.5710
           β    0.5238    0.6722    0.7976    0.9403    1.2980
           γ    1.6296    2.0637    2.3649    2.6221    3.1728
           δ    0.6443    0.7812    0.8702    0.9546    1.1361
```
...
Status `/cache/build/default-amdci4-0/julialang/turingtutorials/tutorials/10-bayesian-differential-equations/Project.toml`
  ...
  [1ed8b502] SciMLSensitivity v7.35.0
...
⌃ [aae01518] BandedMatrices v0.17.22
...
⌃ [727e6d20] SimpleNonlinearSolve v0.1.10
  ...
  [7792a7ef] StrideArraysCore v0.4.16
