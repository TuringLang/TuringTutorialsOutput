...
Log evidence      = -3.725372172749423
Iterations        = 1:1:1000
Number of chains  = 1
...
Summary Statistics
  parameters      mean       std   naive_se      mcse         ess      rhat
    ...
    ⋯
          ...
          s²    2.9787    5.2451     0.1659    0.1549   1010.4105    0.9990
    ⋯
           m    0.0271    1.5255     0.0482    0.0385   1057.5504    1.0003
    ⋯
                                                                1 column om
itted
...
Quantiles
  parameters      2.5%     25.0%     50.0%     75.0%     97.5%
      Symbol   Float64   Float64   Float64   Float64   Float64
          ...
          s²    0.4929    1.1086    1.7775    3.1168   12.6036
           m   -3.0910   -0.8114    0.0622    0.8734    3.1207
```
...
Log evidence      = -3.680561296979398
Iterations        = 1:1:1000
Number of chains  = 1
Samples per chain = 1000
...
Summary Statistics
  parameters      mean       std   naive_se      mcse         ess      rhat
    ...
    ⋯
          ...
          s²    2.6556    3.3561     0.1061    0.1150    964.5219    1.0060
    ⋯
           m   -0.0014    1.6201     0.0512    0.0490   1013.5962    0.9991
    ⋯
                                                                1 column om
itted
...
Quantiles
  parameters      2.5%     25.0%     50.0%     75.0%     97.5%
      Symbol   Float64   Float64   Float64   Float64   Float64
          ...
          s²    0.5284    1.1109    1.7911    2.9777    9.9523
           m   -3.2612   -0.9099   -0.0141    0.9268    3.1158
```
...
```
DynamicPPL.Model{typeof(Main.##WeaveSandBox#310.gdemo), (:x, :y), (), (), T
uple{Float64, Int64}, Tuple{}, DynamicPPL.DefaultContext}(Main.##WeaveSandB
ox#310.gdemo, (x = 1.5, y = 2), NamedTuple(), DynamicPPL.DefaultContext())
```
...
```
Turing.Inference.HMC{Turing.Essential.ForwardDiffAD{0, standardtag} where s
tandardtag, (), AdvancedHMC.UnitEuclideanMetric}(0.01, 10)
```
