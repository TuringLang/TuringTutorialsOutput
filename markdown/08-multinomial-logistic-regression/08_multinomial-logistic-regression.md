...
```
Status `/cache/build/default-amdci4-0/julialang/turingtutorials/tutorials/08-multinomial-logistic-regression/Project.toml`
...
```
Status `/cache/build/default-amdci4-0/julialang/turingtutorials/tutorials/08-multinomial-logistic-regression/Manifest.toml`
