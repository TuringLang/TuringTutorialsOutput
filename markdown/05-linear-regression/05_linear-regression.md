...
Wall duration     = 5.61 seconds
Compute duration  = 5.61 seconds
...
```
      Status `/cache/build/default-aws-shared0-3/julialang/turingtutorials/tutorials/05-linear-regression/Project.toml`
...
```
      Status `/cache/build/default-aws-shared0-3/julialang/turingtutorials/tutorials/05-linear-regression/Manifest.toml`
